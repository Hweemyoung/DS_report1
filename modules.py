...
class ConvLayers(nn.Module):
    def __init__(self, in_channels, out_channels_list, kernel_size_list, stride_list, dropout_list,
...
class Decoder(nn.Module):
    def __init__(self,
        ...
        self.linear_projection_mel = LinearNorm(
            ...
            # Concatenate attention context vector and LSTM output
...
def checkup():
    ...
    embedding = CharacterEmbeddings(30, 128)
    batch_size = 32
